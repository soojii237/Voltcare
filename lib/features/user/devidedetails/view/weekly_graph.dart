...
class WeeklyDeviceGraphPage extends StatefulWidget {
  const WeeklyDeviceGraphPage({super.key});

  @override
  State<WeeklyDeviceGraphPage> createState() => _WeeklyDeviceGraphPageState();
}

class _WeeklyDeviceGraphPageState extends State<WeeklyDeviceGraphPage> {
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Weekly Electricity Consumption (Device-wise)",
                          style: TextStyle(
                            fontSize: 20.sp,
                            fontWeight: FontWeight.bold,
